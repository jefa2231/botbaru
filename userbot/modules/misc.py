...
async def reedme(e):
    await e.edit(
        ...
        "\n[DCLXVI UserBot's README.md file](https://github.com/jefa2231/botbaru/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit("[Repo](https://github.com/jefa2231/botbaru) GitHub's page.")
